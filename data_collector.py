...
def fetch_live_fd_rates(query: str = "all") -> str:
    ...
    In production: replace with real HTTP scraper or Blostem SDK call.
    """
    rates_data = {
...
def compare_bank_rates(tenure_months: str = "12") -> str:
    ...
    banks = json.loads(fetch_live_fd_rates("all"))["banks"]
    comparison = []
    for b in banks:
